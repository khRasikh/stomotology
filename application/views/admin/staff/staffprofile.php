    ...
    <div class="row">  
         <div class="col-md-12"> 
            <section class="content-header">
                <h1><br/>جزییات کامل کارمند<br></h1><br>
            ...
            <div class="box box-primary" <?php
                ...
                <div class="box-body box-profile">
                   <div class="row">
                        <div class="col-md-12">
                        <div class="col-md-3">
                            <img class="profile-user-img img-responsive " src="<?php echo base_url() . "uploads/staff_images/" . $file ?>" alt="User profile picture">
                        ...
                        <div class="col-md-3">
                            <ul class="list-group list-group-bordered">
                                <li class="list-group-item listnoback">
                                    <b><i class="fa fa-user"></i><?php echo $this->lang->line('staff_id'); ?></b> <a class="pull-right text-aqua"><?php echo $staff['employee_id']; ?></a>
                                </li>
                                ...
                                <li class="list-group-item listnoback">
                                    <b>بخش مربوطه</b> <a class="pull-right text-aqua"><label class="label label-warning">بازاریاب</label></a>
                                </li>
                                <li class="list-group-item listnoback">
                        ...
                        <li class="list-group-item listnoback">
                            <b><?php echo $this->lang->line('basic_salary'); ?></b> <a class="pull-right text-aqua"><label class="label label-success"><?php echo $staff['basic_salary']; ?> افغانی</label></a>
                        </li>
                        ...
                        <li class="list-group-item listnoback">
                            <b><?php echo $this->lang->line('basic_salary'); ?></b> <a class="pull-right text-aqua"><?php echo $staff['basic_salary']; ?> افغانی</a>
                        </li>
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <!-- <li class=""><a href="#paroll" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('payroll'); ?></a></li> -->
                        <li class=""><a href="#assigned_patients" data-toggle="tab" aria-expanded="true">داکتران مربوطه</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="assigned_patients">
                            <div class="download_label">لیست داکتران مربوطه <?php echo $staff["name"] . " " . $staff["surname"]; ?></div>
                                ...
                                <table class="table table-hover table-striped example">
                                    ...
                                    //print_r($resultlist); die();
                                        ...
                                        <tr class="">
                                            ...
                                            <td style="color: green; font-weight: bold;"><?php echo get_last_amount($student['id']); ?></td>
                                            <td><?php if($should_pay==""){echo 0; } else{echo $should_pay;} ?></td>
                                            <td style="color: red; font-weight: bold;"><?php echo $should_pay-$paid; ?></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td> </td>
                                            <td> </td>
                                            <td><?php echo $all_paid; ?></td>
                                            <td><?php echo $all_payment; ?></td>
                                            <td><?php echo $all_payment-$all_paid; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>    
                        ...
                        <div class="row">
                                <div class="col-md-4 col-sm-6">
                                    <div class="staffprofile">
                                        ...
                                        <h5>مجموع حسابی داکتران</h5>
                                        <h3><?php
                                            if (!empty($all_payment)) {
                                                echo $all_payment." ".$currency_symbol;
                                            } else {
                                                echo "0"." ".$currency_symbol;
                                            }
                                            ?></h3> 
                                        <div class="icon mt12font40">
                                            <i class="fa fa-money"></i>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="staffprofile"  style="color: green;">

                                        <h5>مجموع رسید</h5>
                                        <h3><?php
                                            if (!empty($all_paid)) {
                                                echo $all_paid." ".$currency_symbol;
                                            } else {
                                                echo "0"." ".$currency_symbol;
                                            }
                                            ?></h3> 
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="staffprofile"  style="color: red;">

                                        <h5>مجموع باقیات</h5>
                                        <h3><?php
                                            if (!empty(-$all_paid+$all_payment)) {
                                                echo " ".  (-$all_paid+$all_payment)." ".$currency_symbol;
                                            } else {
                                                echo   " 0 ".$currency_symbol;
                                            }
                                            ?></h3> 
