                    ...
                    <div class="box-header with-border">
                        ...
                        <small class="pull-right">
                            <?php if ($this->rbac->hasPrivilege('apply_leave', 'can_add')) { ?>
                                <a href="<?php echo site_url('admin/staffattendance/attendancereport'); ?>" style="border-radius:2px 0px 0px 2px" class="btn btn-success btn-sm"><i class="fa fa-book"></i>  نمایش حاضری</a>
                                <div class="btn-group" style="margin-left:4px;">
                                    <a href="<?php echo site_url('admin/staff/create'); ?>" style="border-radius:2px 0px 0px 2px" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_staff'); ?></a>
