                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-sm-5 form-box <?php echo $offset; ?>">
                            <div class="loginbg">  
                                <h2 style="color: white;">شفاخانه ستوماتولوژی</h2>
                                <h4 style="color: white;">سیستم مدیریتی دندانسازی داکتر ایمل</h4>
                                <h4 class="font-white bolds">لطفا نام و پسورد خود را وارد سیستم نمایید</h4>
