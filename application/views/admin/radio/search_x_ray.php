            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">X-Ray Test</h3>
                            ...
                            <tbody>
                                <?php
                                    foreach ($resultlist as $student) {
                                           ...
                                           $last_lab_round = show_last_round('lab_xray',$patient_id);
                                        ...
                                        <tr class="">
                                            ...
                                            <td><?php echo $student['x_ray_size']; ?></td>
                                            <td><?php echo $student['loss']; ?></td>
                                            <td><?php echo $student['created_at']; ?></td>
                                            <td><?php echo $student['result']; ?>
                                                <label style="padding: 2px; border-radius: 5px;" class="btn-danger pull-right">
                                                <?php 
                                                $updated = is_new_or_updated('lab_xray',$student['patient_id'],$last_lab_round);
                                            ...
                                            <a href="<?php echo base_url(); ?>admin/patient/print_lab/<?php echo $student['unique_id'] ?>/<?php echo  $last_lab_round; ?>/lab_xray/" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Print"><i class="fa fa-print"></i></a>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-media-content">
                    <div class="modal-header modal-media-header">
                        ...
                        <h4 class="box-title">Edit in xray Test</h4> 
                    </div>
                    ...
                    <div 
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                                <form  accept-charset="utf-8"  method="post" action="<?php echo base_url() . "admin/radio/updateLabXray" ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php 
                                        $lab_ultra = show_examination_result('lab_xray',$student['unique_id'],$last_opd_details_round);
                                        ...
                                        { ?>
                                            ...
                                            <div class="col-sm-1">
                                                <div class="form-group">
                                                    <label>Size</label>
                                                    <input type="text" name="x_ray_size"  id="x_ray_size<?php echo $value['id']; ?>" value="<?php echo $value['x_ray_size']; ?>" class="form-control" >
                                                </div>
                                            </div>
                                            <div class="col-sm-1">
                                                <div class="form-group">
                                                    <label>Loss</label>
                                                    <input type="text" name="loss"  id="loss_id<?php echo $value['id']; ?>" value="<?php echo $value['loss']; ?>" class="form-control" >
                                                </div>
                                            </div>
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php if(empty($value['exam_type']) OR empty($value['description'])) { ?>
                                                        ...
                                                        <button  type="button" class='btn btn-success'
                                                         onclick="add_xray_result(<?php echo $value['id']; ?>);"  class="form-control" >
                                        ...
                                        <div class="row">
                                        <div class="col-sm-4">
                                        <?php $extra_information = show_lab_lab_ex_information('lab_xray',$student['patient_id'],$last_lab_round); ?>
                                            <div class="form-group">
...
function add_xray_result(id)
{
    ...
    var size =document.getElementById('x_ray_size'+id).value;
    var loss =document.getElementById('loss_id'+id).value;
    $.ajax({
    type:'POST',
    data:{lab_id:lab_id,exam_type:exam_type, x_ray_size:size, loss:loss, description:description},
    url: '<?php echo base_url(); ?>admin/radio/update_Lab_xray',
...
<script type="text/javascript">
            ...
            function bring_x_ray(id) {

                $.ajax({
                    url: '<?php echo base_url(); ?>admin/radio/bring_x_ray',
                    type: "POST",
                    data: {patient_id: id},
                    dataType: 'json',
                    success: function (data) {
                        ...
                        $("#edit_description").val(data.result);
                        $("#edit_x_ray_size").val(data.x_ray_size);
                        $("#edit_x_ray_desc").val(data.x_ray_desc);
                        $("#edit_loss").val(data.loss);
            ...
            $(document).ready(function (e) {
                $("#formedit").on('submit', (function (e) {
                    e.preventDefault();
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/radio/updateLabXray',
                        type: "POST",
