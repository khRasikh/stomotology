            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">ECG Test</h3>
                            ...
                            <tbody>
                                <?php
                                    foreach ($resultlist as $student) {
                                           ...
                                           $last_lab_round = show_last_round('lab_ecg',$patient_id);
                                        ...
                                        <tr class="">
                                            ...
                                            <td><?php echo $student['result']; ?>
                                             <label style="padding: 2px; border-radius: 5px;" class="btn-danger pull-right">
                                              <?php 
                                              $updated = is_new_or_updated('lab_ecg',$student['patient_id'],$last_lab_round);
                                              if($updated == 0){ echo "New";} else echo ""; ?>
                                              </label>
                                            </td>
                                            <td>
                                            <a href="<?php echo base_url(); ?>admin/patient/print_lab/<?php echo $student['unique_id'] ?>/<?php echo  $last_lab_round; ?>/lab_ecg" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Print"><i class="fa fa-print"></i></a>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-media-content">
                    <div class="modal-header modal-media-header">
                        ...
                        <h4 class="box-title">Edit in ECG Test</h4> 
                    </div>
                    ...
                    <div 
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                                <form  accept-charset="utf-8"  method="post" action="<?php echo base_url() . "admin/radio/updatePatientECG" ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php 
                                        $lab_ultra = show_examination_result('lab_ecg',$student['unique_id'],$last_opd_details_round);
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php if(empty($value['exam_type']) OR empty($value['description'])) { ?>
                                                        ...
                                                        <button  type="button" class='btn btn-success'
                                                         onclick="add_ecg_result(<?php echo $value['id']; ?>);"  class="form-control" >
                                        ...
                                        <div class="row">
                                        <div class="col-sm-4">
                                        <?php $extra_information = show_lab_lab_ex_information('lab_ecg',$student['patient_id'],$last_lab_round); ?>
                                            <div class="form-group">
...
function add_ecg_result(id)
{
    ...
    url: '<?php echo base_url(); ?>admin/radio/update_Lab_ecg',
...
<script type="text/javascript">
            ...
            function bring_x_ray(id) {
                ...
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/radio/bring_ecg',
                    type: "POST",
                    data: {patient_id: id},
                    dataType: 'json',
                    success: function (data) {
                        ...
                        $("#edit_patient_fname").val(data.patient_fname);
                        $("#edit_age").val(data.age);
                        $("#edit_date").val(data.date);
                        $("#edit_fees").val(data.fees);
                        $("#edit_operation_type").val(data.operation_type);
                        $("#edit_observation").val(data.result);
            ...
            $(document).ready(function (e) {
                $("#formedit").on('submit', (function (e) {
                    e.preventDefault();
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/radio/updatePatientECG',
                        type: "POST",
