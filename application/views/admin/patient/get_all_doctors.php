            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <?php } else { ?>
                            <h3 class="box-title titlefix"> لیست مجموعی داکتران </h3>

                        <?php } ?>
                        <div class="box-tools pull-right">
								<a  href="<?php echo base_url('admin/patient/reg_search')?>" class="btn btn-default btn-sm"><i class="fa fa-list">&nbsp; </i>  لیست داکتران دایمی </a> 
                    ...
                    if (isset($resultlist)) {
                        ?>
                        <div class="box-body">
                            <div class="download_label">لیست داکتران </div>
                                ...
                                <tbody style="text-align: center;">
                                   ...
                                   //print_r($resultlist); die();
                                    ...
                                    <tr class="">
										...
										<td><?php if($student['mobileno']==""){echo "0";} else{ echo $student['mobileno'];}?></td>
										...
										<td style="color: red; font-weight: bold;"><?php if(($should_pay-$paid)<0){echo ($should_pay-$paid)." طلبکار";} else{echo $should_pay-$paid;} ?>
										</td>
                                        <td>
                                            <a href="<?php echo base_url(); ?>admin/staff/profile/<?php echo $student['payment']; ?>">
                                                <?php if($student['sname']=='Super Admin'){echo '-'; } else{echo $student['sname'];} ?> 
                                            </a>
                                        </td> 
                                    </tr>
                                            <?php
