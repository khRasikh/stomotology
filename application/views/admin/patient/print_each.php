	...
	<body>
				...
				$count=0; 
					foreach ($count_each_lab as $kye => $value) {
						...
						<tr>
							...
							<td><?php echo $value['countset'];  ?></label> ساخت</td>
							<td><?php echo intval($value['fee']/$value['countset']);  ?></label> </td>
			...
			<tbody style="width: 40px;">
				...
				<tr>
					...
					<td></td>
					<td><b><?php if($sum==null){echo "0";}else{echo $sum;}?> افغـ</b></td>
				</tr>
				...
				<tr >
					...
					<td></td>
					<td><b><?php if (($sum_all-$paid_old)==null){echo "0";} else{echo ($sum_all-$paid_old); }?> افغـ</></td>
				</tr>
				<tr style="text-align: center;">
					<td>امضا: ________________________________</td>
				</tr>
