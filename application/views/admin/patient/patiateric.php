                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <?php if ($title == 'old_patient') { ?>
                            <h3 class="box-title titlefix"><?php echo $this->lang->line('opd') . " " . $this->lang->line('old') . " " . $this->lang->line('patient') ?> Padiateric List</h3>
                        <?php } else { ?>
                            <h3 class="box-title titlefix"><?php echo $this->lang->line('opd') . " " . $this->lang->line('patient') ?>    Padiateric List</h3>
                        <?php } ?>
                                            ...
                                            <tr class=""> 
                                                ...
                                                <td>
                                                      <?php if ($this->rbac->hasPrivilege('revisit', 'can_add')) { ?>
                                                        ...
                                                        <a href="#" onclick="getRevisitRecord('<?php echo $student['id'] ?>')" class="btn <?php if($student['is_info'] == 1) echo 'btn-danger btn-sm'; else echo 'btn-default'; ?>"  data-toggle="tooltip" title="Add information"><i class="fas fa-plus"></i>
                                                        </a>
                                                    <?php } ?> 
            ...
            <div class="modal-body pt-20 pb-20">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                        <form id="add_information"   accept-charset="utf-8"   enctype="multipart/form-data" method="post" >
                                    ...
                                    <div class="row ptt10">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="pids" name="patient_id">
...
<script type="text/javascript">
            ...
            $(document).ready(function (e) {
                $("#add_information").on('submit', (function (e) {
                    e.preventDefault();
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/patient/add_info',
                        type: "POST",
                        data: new FormData(this),
                        dataType: 'json',
                        contentType: false,
