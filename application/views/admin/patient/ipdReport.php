                         ...
                         <table class="table table-striped table-bordered table-hover example">
                                    ...
                                    <tbody> 
                                        ...
                                        //     $payment = $report["paid_amount"];
                                              $total_fees = show_data2('total_fees','patient_nursing',$report['patient_id'],$report['round']);
                                              $opfee = show_data_sum('operation_theatre',$report['patient_id'],$report['round']);
                                              $ttl = $report["entrance_fee"] + $total_fees + $opfee;
                                              $total += $report["entrance_fee"];
                                              $total2 += $ttl;
                                         
                                                ?>
                                                <tr>
                                                    <td><?php echo $report['patient_id']; ?></td>
                                                    <td><?php echo $report['round']; ?></td>
                                                    <td><?php show_data('hmis_nu','opd_details',$report['patient_id'],$report['round']); ?></td>
                                                    <td><?php echo $report['patient_name']; ?></td>
                                                    <td><?php echo $report['guardian_name']; ?></td> 
                                                    <td><?php echo $report['date']; ?></td>  
                                                    <td><?php show_data('diagnoses','opd_details',$report['patient_id'],$report['round']); ?></td>  
                                                    <td><?php show_data('therapies','opd_details',$report['patient_id'],$report['round']); ?></td> 
                                                    <td><?php echo $report['entrance_fee']; ?></td> 
                                                    <td><?php echo $total_fees; ?></td>  
                                                    <td><?php show_data('bed_time','patient_nursing',$report['patient_id'],$report['round']); ?> Nights</td>  
                                                    <td><?php echo $opfee; ?> </td>
                                                    <td><?php echo $ttl; ?> </td>                                                  
                                                    <td><?php echo $report['blood_group']; ?></td>
                                                    <td><?php echo $report['died']; ?></td>
                                                    <td><?php echo $report['escape']; ?></td> 
                                                    <td><?php echo $report['referred_to']; ?></td>
                                                    <td><?php echo $report['exit_date']; ?></td>
                                        ...
                                        <tr class="box box-solid total-bg">
                                            <td colspan='8'><span style="color:blue;">Total</span></td>
                                            <td style="color:blue;"><?php echo $total; ?><span></td>
                                            <td colspan='3' style="color:blue;"></td>
                                            <td style="color:blue;"><?php echo $total2; ?></td>
                                            <td colspan='5'></td>
                                        </tr> 
                                   <?php } ?>
                                </table>
