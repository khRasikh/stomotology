            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <?php } else { ?>
                            <h3 class="box-title titlefix">OPD Patient General Surgery List</h3>
            ...
            <div class="modal-body pt-20 pb-20">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                        <form id="add_information" action="<?php echo base_url(''); ?>admin/patient/add_information" accept-charset="utf-8"   enctype="multipart/form-data" method="post" >
                             <input id="patient_id" name="patient_id" type="hidden" />
                            <input id="is_info" name="is_info" value="1" type="hidden" />
