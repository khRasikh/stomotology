<link rel="stylesheet" href="http://localhost/stomotology/backend/fa_datepicker//datepicker.css">
<script src="http://localhost/stomotology/backend/fa_datepicker/datepicker.min.js"></script>
<script src="http://localhost/stomotology/backend/fa_datepicker/datepicker.js"></script>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="date" name="date" placeholder="" type="text" class="form-control date"  
                                        value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>" readonly="readonly"/>
                                         
<!-- <div class="calender">
    <input id="fadate" name="fadate" placeholder="" type="text" class="form-control"/>
</div>
    ...
    format : "short"
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="year_id" name="year">
                            ...
                            <div class="box-body">
                                ...
                                if (!empty($resultlist)) {
                                    ...
                                    <form action="<?php echo site_url('admin/staffattendance/index') ?>" method="post">
                                        ...
                                        <input type="hidden" name="year" value="1400">
                                                    ...
                                                    foreach ($resultlist as $key => $value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php if ($value["date"] == 'xxx') { ?> 
                                                                ...
                                                                <!-- <input type="number" value="34" name="myday"/> -->
                                                            <?php } else { ?>
