                                    ...
                                    <div class="padd-en-rtl33"> 
                                        <table class="table mb0 font13" >
                                            ...
                                            foreach ($monthAttendance as $attendence_key => $attendence_value) {
                                                ...
                                                <?php $Total_present += $attendence_value['present']; ?>
                                                <?php
                                            }
                                            ?>
                                            <tr>
                        ...
                        <div class="box-header">
                            <div class="row display-flex">
                                <div class="col-md-4 col-sm-4">
                                    <h5 class="box-title">اضافه کاری</h5>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <h3 class="box-title"><?php echo $this->lang->line('deduction'); ?> معاش</h3>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="sameheight">
                                        <div class="payrollbox feebox">
                                            ...
                                            <input type="hidden" id="basic_val" value="<?php echo $total_salary; ?>"/>
                                            <div class="form-group">
                                                <label class="col-sm-6 control-label">مجموع اضافه کاری</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" disabled name="total_allowance" id="total_allowance"  type="text" />
                                                </div>
                                            </div><!--./form-group-->
                                            
                                            <div class="form-group">
                                                <label class="col-sm-6 control-label" style="color: red; ">مجموع کسرمعاش</label>
                                                <div class="col-sm-6 deductiondred">
                                                    <input class="form-control" name="total_deduction" id="total_deduction" disabled type="text" style="color:#f50000" />
                                                </div>
                                            </div><!--./form-group-->

                                            <div class="form-group">
                                                <label class="col-sm-6 control-label"><?php echo $this->lang->line('gross_salary'); ?></label>
                                                <div class="col-sm-6">
