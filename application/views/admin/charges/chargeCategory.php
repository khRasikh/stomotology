                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <?php if ($this->rbac->hasPrivilege('charge_category', 'can_edit')) { ?> 
                                                    <a onclick="get(<?php echo $category['id']; ?>)" data-target="#editmyModal"  class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">Edit Record
