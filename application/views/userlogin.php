...
<html lang="en">
    <head>
        ...
        <title>Shuhada Hospital Management Information System</title>
        <!--favican-->
                            ...
                            <div class="loginbg">  
                                <div class="form-top">
                                    <div class="form-top-left">
                                        <img src="http://localhost/rasikhhms/uploads/hospital_content/logo/login_logo1.JPG" style="    height: 57px; margin-top: -20px;">    
                                    </div>
                                ...
                                <div class="form-bottom">
                                    <h3 class="font-white bolds">Please Enter Your Credentials Accurately.</h3>
                                    <?php
