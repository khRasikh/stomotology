                                            ...
                                            foreach ($consultant_register as $consultant_key => $consultant_value) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $consultant_value["cons_doctor"] ?></td>
                                                        <td><?php echo $consultant_value["instruction"] ?></td>
                                                        <td><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($consultant_value['cons_doctor'])); ?></td>
                                                    </tr>
                                                <?php
                                            }
                                        }
                                ...
                                <div class="impbtnview">
                                    ...
                                    if (!empty($payment_method)) {
                                        ...
                                        <?php if ($result["is_active"] == 'yes') { ?>
                                            <button type="button" class="btn btn-info" data-result_id="<?php echo $result['id'] ?>" data-toggle="modal" 
                                            data-target="#payMoney"><i class="fa fa-plus"></i> <?php echo $this->lang->line('make_payment'); ?></button>
    <?php } ?>
    <?php
}
?>
