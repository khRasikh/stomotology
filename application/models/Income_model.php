...
class Income_model extends CI_Model {
   ...
   public function get($id = null) {
        $this->db->select('income.*')->from('income');
        $this->db->join('income_head', 'income.inc_head_id = income_head.id');
        if ($id != null) {
    ...
    public function getOpdIncome($date_from,$date_to)
    {
        $query = $this->db->query("SELECT SUM(amount) FROM opd_details WHERE date = '$date_from' ");
